 ...
 */
public class IsAsteroid extends OneArgumentExecutable<Expression<EntityType>>
        implements Expression<BooleanType> {

    public IsAsteroid(Expression<EntityType> argument)
    ...
    public BooleanType calculate(Program program) throws RuntimeException{
        ...
        return new BooleanType(e instanceof Asteroid);
    }
}
